...
parser.add_argument( "--model", help="filename for output file", default="start.advanced1.lc.lc.fences", required=False )
...
lcA = LocallyConnected2D( name="lcA", filters=5, kernel_size=(1,1), padding='valid', input_shape=(36, 19, 14), data_format='channels_last', activation='relu', use_bias=True )( input2 )
lcB = LocallyConnected2D( name="lcB", filters=5, kernel_size=(3,3), padding='valid', input_shape=(36, 19,  5), data_format='channels_last', activation='relu', use_bias=True )( lcA )
