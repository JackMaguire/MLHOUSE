...
for line in file:
    ...
    for i in range( 0, len( input ) ):
        ...
        count = count + 1
        print( output[ i ][ 0 ], output[ i ][ 1 ], predictions[ i ][ 0 ], predictions[ i ][ 1 ], predictions[ i ][ 2 ], predictions[ i ][ 3 ], predictions[ i ][ 4 ], predictions[ i ][ 5 ], predictions[ i ][ 6 ], predictions[ i ][ 7 ] );
        loop_count += 1
        if loop_count > 1000:
            exit( 0 )
        '''
