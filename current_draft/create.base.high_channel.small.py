...
B = Conv2D( name="layerB", filters=15, kernel_size=(1,1), padding='valid', input_shape=A.shape, data_format='channels_last', activation='relu', use_bias=True )( A )
...
E = LocallyConnected2D( name="layerE", filters=6, kernel_size=(1,1), strides=(1,1), padding='valid', data_format='channels_last', activation='relu', use_bias=True )( D )
print( E.shape )
