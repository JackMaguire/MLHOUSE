...
if os.path.isfile( "../current.base.high_channel.h5" ):
    model1 = load_model( "../current.base.high_channel.h5" )
else:
    print( "Model ../current.base.high_channel.h5 is not a file" )
    exit( 1 )
...
model1.save( "final.base.high_channel.h5" )
