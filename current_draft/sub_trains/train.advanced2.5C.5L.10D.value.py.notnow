...
if os.path.isfile( "../current.advanced2.5C.5L.10D.value.h5" ):
    model1 = load_model( "../current.advanced2.5C.5L.10D.value.h5" )
else:
    print( "Model ../current.advanced2.5C.5L.10D.value.h5 is not a file" )
    exit( 1 )
...
model1.save( "final.advanced2.5C.5L.10D.value.h5" )
