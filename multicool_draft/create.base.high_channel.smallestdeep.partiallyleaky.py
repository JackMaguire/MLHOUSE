...
in1dense1_act = LeakyReLU( name="indense1_act", alpha=0.125 )( in1dense1 )
in1dense2 = Dense( name="in1dense2", units=50 )( in1dense1_act )
in1dense2_act = LeakyReLU( name="indense2_act", alpha=0.125 )( in1dense2 )
in1dense3 = Dense( name="in1dense3", units=20 )( in1dense2_act )
in1dense3_act = LeakyReLU( name="indense3_act", alpha=0.125 )( in1dense3 )
...
dense1_act = LeakyReLU( name="dense1_act", alpha=0.125 )( dense1 )
dense2 = Dense( name="dense2", units=50 )( dense1_act )
dense2_act = LeakyReLU( name="dense2_act", alpha=0.125 )( dense2 )
dense3 = Dense( name="dense3", units=50 )( dense2_act )
dense3_act = LeakyReLU( name="dense3_act", alpha=0.125 )( dense3 )
dense4 = Dense( name="dense4", units=50 )( dense3_act )
dense4_act = LeakyReLU( name="dense4_act", alpha=0.125 )( dense4 )
