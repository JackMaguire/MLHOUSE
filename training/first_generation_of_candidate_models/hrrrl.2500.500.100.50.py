...
parser.add_argument( "--model", help="filename for output file", default="hrrrl.2500.500.100.50", required=False )
...
model.add( Dense( num_neurons_in_layer1, input_dim=num_input_dimensions, activation='hard_sigmoid') )
