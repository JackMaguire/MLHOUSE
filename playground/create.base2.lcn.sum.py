...
B2 = LeakyReLU()( B2 )
B3 = Conv2D( name="layerB3", filters=12, kernel_size=(1,1), padding='valid', data_format='channels_last', use_bias=True )( B2 )
B3 = LeakyReLU()( B3 )
...
#print( Epool.shape )
F = LocallyConnected2D( name="layerF", filters=15, kernel_size=(5,5), strides=(2,2), padding='valid', data_format='channels_last', use_bias=True )( E )
F = LeakyReLU()( F )
print( F.shape )
