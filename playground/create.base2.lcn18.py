...
parser.add_argument( "--model", help="filename for output file", default="start.base2.lcn18", required=False )
args = parser.parse_args()

num_input_dimensions1 = 26
num_input_dimensions2 = 17496 #(18494 - num_input_dimensions1) * (18.0 / 19.0)
...
# Phase 1: in2 -> ABCDE
pre = Reshape( target_shape=(36, 18, 27,) )( input2 )#ALWAYS DO WIDTH, HEIGHT, CHANNELS
...
B4 = LocallyConnected2D( name="layerB4", filters=15, kernel_size=(2,2), strides=(2,2), padding='valid', data_format='channels_last', activation='relu', use_bias=True )( B3 )
